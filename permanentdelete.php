...
if ( $_SERVER["REQUEST_METHOD"] == "GET")
{
        ...
        <body class="d-flex justify-content-center align-items-center vh-100 bg-light" style="font-family: Poppins, sans-serif;">
            <div class="container text-center">
                <div class="p-4 bg-white shadow-lg rounded mx-auto" style="max-width: 450px;">
                    ...
                    <a href="recover.php" class="btn btn-primary fw-bold">🔙 Kembali
                </div>
            </div>
        </body>
        </html>';
    ...
    if (isset($_GET['confirm']) && $_GET['confirm'] === 'yes') {
        ...
        if ($del > 0) {
            ...
            <p>Data berhasil dihapus secara permanen!</p>
            </div>
            ...
            <meta charset="UTF-8">
            <meta name="viewport" content="width=device-width, initial-scale=1">
            <title>Data Gagal Dihapus</title>
            <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
            </head>
...
<head>
    ...
    <title>Hapus Permanen Data Mahasiswa</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <style>
        .card {
            max-width: 600px;
...
<div class="container">
    <div class="card">
        <div class="card-header text-center bg-danger text-white">
            <h3>Konfirmasi Hapus Permanen Data Mahasiswa</h3>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="btn-group-custom">
                ...
                <a href="permanentdelete.php?id=<?= $result['id']; ?>&confirm=yes" class="btn btn-danger">🗑️ Ya, Hapus Permanen</a>
            </div>
        </div>
    </div>
</div>
