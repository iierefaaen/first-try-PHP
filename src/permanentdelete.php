...
if ( $_SERVER["REQUEST_METHOD"] == "GET")
{
    ...
    if (isset($_GET['confirm']) && $_GET['confirm'] === 'yes') {
        ...
        if ($recover === 1) {
            alert_popup('Berhasil','Data berhasil dihapus permanen','success', "success", "recover.php");
            exit;
        } else {
            alert_popup("Gagal","Data gagal dihapus permanen","danger", "danger","recover.php");
            exit;
        }
    }
}
...
<div class="container">
    <div class="card">
        <div class="card-header text-center bg-danger text-white">
            <h3>Konfirmasi Penghapusan Permanen Data</h3>
        </div>
